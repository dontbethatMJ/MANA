...
const NavBar = () => {
  ...
  return (
    <div className="relative">
      <motion.div className="z-50 w-[95%] max-w-[48rem] mx-auto fixed top-4 left-1/2 transform -translate-x-1/2 flex items-center justify-between rounded-xl border-[1px] border-[#ffffff19] bg-[#ffffff2d] py-3 px-4 shadow-lg backdrop-blur-md transition-all duration-300">
